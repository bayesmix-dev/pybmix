...
from pybmix.core.hierarchy_mixing_changer import change_hierarchy, change_non_conjugate_hierarchy, change_mixing
...
mixing = PythonMixing(state=[5], prior=[0]) # Python implementation of DP mixing
